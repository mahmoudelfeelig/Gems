...
- Energy rules: follow `checklist.md` (Legendary/Broken ladder, kill gains, death losses, Legendary +5 glint and upgrade-item drops, Broken  can be fixed with an upgrade item).
