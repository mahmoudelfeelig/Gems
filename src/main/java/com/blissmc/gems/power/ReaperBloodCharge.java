...
public final class ReaperBloodCharge {
    static final String KEY_CHARGING_UNTIL = "reaperBloodChargeChargingUntil";
    static final String KEY_CHARGED_TICKS = "reaperBloodChargeChargedTicks";
    static final String KEY_BUFF_UNTIL = "reaperBloodChargeBuffUntil";
    static final String KEY_BUFF_MULT = "reaperBloodChargeBuffMultiplier";
