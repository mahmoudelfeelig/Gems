...
public final class DuelistsRapierItem extends Item implements LegendaryItem {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, TooltipDisplayComponent displayComponent, Consumer<Text> tooltip, TooltipType type) {
        GemsTooltipFormat.appendDescription(
                tooltip,
                Text.translatable("gems.item.duelists_rapier.tooltip.1"),
                Text.translatable("gems.item.duelists_rapier.tooltip.2"),
                Text.translatable("gems.item.duelists_rapier.tooltip.3")
        );
    }
}
