...
public final class ReversalMirrorItem extends Item implements LegendaryItem {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, TooltipDisplayComponent displayComponent, Consumer<Text> tooltip, TooltipType type) {
        GemsTooltipFormat.appendDescription(
                tooltip,
                Text.translatable("gems.item.reversal_mirror.tooltip.1"),
                Text.translatable("gems.item.reversal_mirror.tooltip.2"),
                Text.translatable("gems.item.reversal_mirror.tooltip.3")
        );
    }
}
